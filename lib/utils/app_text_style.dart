...
class AppTextStyle {
  ...
  static TextStyle regularBlack10 = TextStyle(
    ...
    fontSize: MediaQuery.of(Get.context!).size.width > 500 ? 8.0 : 10.0,
    fontFamily: AppFonts.nexaRegular,
  );
  static TextStyle regularBlack11 = TextStyle(
    color: AppColors.black,
    fontSize: MediaQuery.of(Get.context!).size.width > 500 ? 9.0 : 11.0,
    fontFamily: AppFonts.nexaRegular,
  );
  static TextStyle regularBlack12 = TextStyle(
    color: AppColors.black,
    fontSize: MediaQuery.of(Get.context!).size.width > 500 ? 10.0 : 12.0,
    fontFamily: AppFonts.nexaRegular,
  );
  static TextStyle regularBlack13 = TextStyle(
    color: AppColors.black,
    fontSize: MediaQuery.of(Get.context!).size.width > 500 ? 11.0 : 13.0,
    fontFamily: AppFonts.nexaRegular,
  );
  static TextStyle regularBlack14 = TextStyle(
    color: AppColors.black,
    fontSize: MediaQuery.of(Get.context!).size.width > 500 ? 12.0 : 14.0,
    fontFamily: AppFonts.nexaRegular,
  );
  ...
  static TextStyle boldWhite18 = TextStyle(
    color: AppColors.white,
    fontSize: MediaQuery.of(Get.context!).size.width > 500 ? 16.0 : 18.0,
    fontFamily: AppFonts.nexaBold,
  );
